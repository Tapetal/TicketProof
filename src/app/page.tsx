...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#0B0B14]">
        ...
        <div className="container mx-auto px-4 py-20 relative z-10">
          <div className="text-center mb-14">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/events"
                className="group relative bg-gradient-to-r from-[#6C63FF] to-[#00C6AE] text-white px-8 py-4 rounded-xl font-semibold text-base hover:shadow-[0_0_40px_rgba(108,99,255,0.6)] transition-all transform hover:scale-105"
              >
              ...
              <Link
                href="/events/create"
                className="group relative bg-[#0B0B14] border-2 border-[#FFB400] text-[#FFB400] px-8 py-4 rounded-xl font-semibold text-base hover:bg-[#FFB400] hover:text-[#0B0B14] transition-all transform hover:scale-105"
              >
                Create Event
              </Link>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto mb-12">
            {[
              { value: "0", label: "Events Created", color: "#6C63FF" },
              { value: "0", label: "Tickets Sold", color: "#FFB400" },
              { value: "0", label: "Active Users", color: "#00C6AE" },
              { value: "$0", label: "Volume (HBAR)", color: "#6C63FF" },
            ].map((stat, idx) => (
              <div
                key={idx}
                className="bg-[#0B0B14]/50 backdrop-blur-sm border border-[#6C63FF]/20 rounded-2xl p-5 text-center hover:border-[#6C63FF]/50 transition-all group"
              >
                <div
      ...
      <div className="container mx-auto px-4 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {[
            ...
            <div
              key={idx}
              className="group relative bg-[#0B0B14] border border-[#6C63FF]/20 rounded-2xl p-6 hover:border-[#6C63FF]/50 transition-all transform hover:-translate-y-2"
            >
              <div
      ...
      {/* CTA Section */}
      <div className="container mx-auto px-4 py-20">
        <div className="relative overflow-hidden bg-gradient-to-r from-[#6C63FF] via-[#FFB400] to-[#00C6AE] rounded-3xl p-12 text-center">
          ...
          <div className="relative z-10">
            ...
            <button className="bg-[#0B0B14] text-white px-10 py-4 rounded-xl font-semibold text-base hover:bg-white hover:text-[#6C63FF] transition-all transform hover:scale-105 shadow-2xl">
      ...
      <div className="container mx-auto px-4 pb-20">
        ...
        <div className="flex flex-wrap justify-center items-center gap-10 opacity-50">
          {["Hedera", "HashPack", "Blade", "Firebase", "Web3"].map(
            (partner, idx) => (
              <div key={idx} className="text-xl font-semibold text-[#D1D5DB]">
                {partner}
              </div>
            )
          )}
